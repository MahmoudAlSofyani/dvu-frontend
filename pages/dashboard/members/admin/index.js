    ...
    <Layout>
      <div className="container flex flex-col space-y-6 bg-darkGray p-5 rounded-lg mx-auto max-w-md ">
        ...
        <div className="flex flex-col space-y-4 w-full">
          <CustomButton
            link="/dashboard/members/admin/announcements"
            label="Announcements"
            extraClasses="w-full"
            styleType={2}
          />
          <CustomButton
            label="Events"
            link="/dashboard/members/admin/events"
            extraClasses="w-full"
            styleType={2}
          />
          <CustomButton
            label="Members"
            link="/dashboard/members/admin/members"
            extraClasses="w-full"
            styleType={2}
          />
          <CustomButton
            label="Advertisements"
            link="/dashboard/members/admin/advertisements"
            extraClasses="w-full"
            styleType={2}
          />
        </div>
