...
import { addAdvertisement } from "../../../../src/validators/advertisements-validator";
      ...
      addAdvertisement
        ...
        .then(async () => {
          ...
          if (_response.status === 200) {
            router.push("/dashboard/members/advertisements");
          }
        })
        .catch((err) => {
          if (err && err.inner) {
    ...
    <Layout>
      <div className="container flex flex-col space-y-6 bg-darkGray p-5 rounded-lg mx-auto max-w-md ">
        <SectionHeader
          ...
          backLink="/dashboard/members/advertisements"
        />
